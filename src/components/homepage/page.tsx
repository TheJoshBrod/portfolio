...
o     . * +                              .o       .                           ..                                   - o -                              
  ...
  return (<>
    <div className="min-h-screen w-full relative overflow-hidden bg-[#111]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none opacity-[0.3] flex items-start justify-center">
        <div className="flex flex-wrap w-[150vw] -ml-[25vw] justify-center gap-0">
          {/* Extra wide container centered with negative margin to ensure coverage on all sides */}
          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <div className="flex justify-center gap-8 text-sm mt-6 text-gray-500 font-mono">
              {[
                ...
                { name: "Email", url: "mailto:joshbrod@umich.edu" },
