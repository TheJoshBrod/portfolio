export default function Education() {
    return (
        <div className="flex flex-col w-full max-w-4xl px-4 mt-8">
            ...
            <div className="flex flex-col gap-12 border-l border-gray-800 pl-6 ml-2">
                ...
                <div className="flex flex-col gap-2 relative">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                        <h3 className="text-white font-mono font-bold text-lg">Masters Computer Science</h3>
                        <span className="text-gray-500 text-sm font-mono">Spring 2026*</span>
                    </div>
                    ...
                    <div className="text-xs text-gray-500 font-mono leading-relaxed mt-2">
                        ...
                        Scalable Agentic Systems, Accelerating AI, Human AI Interaction, OpenSource Innovation, Adv. Compilers, Parallel Computing
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2 relative">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                        <h3 className="text-gray-300 font-mono font-bold text-lg">Bachelors Computer Science</h3>
                        <span className="text-gray-500 text-sm font-mono">Spring 2025</span>
                    </div>
            ...
            <p className="text-gray-600 font-mono text-xs mb-2 mt-5">*Expected</p>
        </div>
    );
}